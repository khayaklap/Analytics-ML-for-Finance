...
Ideas for the above projects derive mainly from readings on empirical use cases of machine learning in finance. I am in no shape or form plagiarizing, and always give credit to the authors. Rather than copy their code, I think of ways to enhance their work by identifying shortcomings in their code and explanations. This means naming the variables with relevant terms, optimizing running time, diversifying visualizations, adding markdown cells with math formulas, and structuring the flow of the project with a process-based approach.  
